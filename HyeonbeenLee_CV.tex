...
\geometry{a4paper, left=1.0cm, right=1.0cm, top=0.7cm, bottom=1.2cm} % Set paper size and margins
\usepackage{xhfill}
...
\section*{RESEARCH INTEREST}
 {\small\textbf{Robot Learning $\bullet$ Physics-aware ML $\bullet$ Contact-rich Dynamics $\bullet$ Force and Tactile Sensing $\bullet$ Data-driven Modeling}}
...
\begin{etaremune}[leftmargin=.5cm, itemsep=0.05cm]
	\item \textbf{H. Lee}, M. Jung, J.G. Kim et al., “Forecasting high-frequency force dynamics of real-world contact-rich manipulation via short-time stationarity and freqeuncy-aware neural filters”, \textit{Manuscript in preparation.}

	\item B. Koo, M. Jung, \textbf{H. Lee}, T. Yeu, J.G. Kim, J.B. Han, Y. Lee, D. Park, “Force estimation and haptic feedback of an underwater hydraulic manipulator using a DHP-DNN-based approach”, under review at \textit{IEEE Robotics and Automation Letters}. % {\small({$*$ Formal authorship addition is currently in process})}
...
\begin{minipage}{0.78\textwidth}
	...
	\begin{itemize}
		...
		\item Accelerated and improved the force model for \href{https://www.kriso.re.kr/eng/}{\underline{KRISO}}. Independently secured the project for a year.
...
\begin{minipage}{0.77\textwidth}
	...
	\begin{itemize}
		...
		\item Received a formal internship offer from the lab director based on the presentation performance.
...
\begin{minipage}{0.77\textwidth}
	\footnotesize
	\begin{itemize}
		\item Proposed a novel neural network architecture for learning complex dynamics from multi-order derivatives. Resulted in a first-author publication in \textit{Journal of Computational Physics}.
		...
		\item Designed a generative frequency-aware model to forecast contact-rich force dynamics of a marine excavation robot in real-time for \href{https://www.kriso.re.kr/eng/}{\ul{Korea Research Institute of Ships and Ocean Engineering (KRISO)}}. Independently and successfully secured the project for two years.
...
\begin{itemize}
	...
	\item \textbf{Academic Superiority Scholarship} \hfill Kyung Hee University, 2021 % Mar. 
\end{itemize}
...
\noindent
\textbf{Teaching Assistant, ME380 Multibody System Dynamics} \hfill Dept. of Mechanical Eng., Kyung Hee University\\
...
\begin{itemize}
	...
	\item \textbf{Hee-Sun Choi}, Ph.D.
	      ...
	      \quad{\small Incoming Professor at Department of Artificial Intelligence and Robotics, Sejong University (\href{mailto:mdefptheia@gmail.com}{mdefptheia@gmail.com})}%{\Vhrulefill} 
