...
M.Eng. in Mechanical Engineering {\small(Advisor: Jin-Gyun Kim)} \hfill GPA: 3.93/4.0\\ % M.S. 3.933/4.0, 4.10/4.3, 4.33/4.5
...
B.Eng. in Mechanical Engineering {\small(Advisor: Jin-Gyun Kim, Shinkyu Jeong)}\hfill {(\ul{Upper Div.: 3.88/4.0})} GPA: 3.52/4.0\\ % B.S. Overall 3.517/4.0 ,3.599/4.3, 3.84/4.5
...
\section*{RESEARCH INTEREST}
 {\small\textbf{Robot Learning $\bullet$ Physics-aware ML $\bullet$ Contact-rich Dynamics $\bullet$ Force and Tactile Sensing $\bullet$ Sim-to-real Transfer}}
...
\begin{etaremune}[leftmargin=.5cm, itemsep=0.05cm]
	...
	\item \textbf{H. Lee}, M. Jung, J.G. Kim et al., ``Frequency-aware probabilistic learning of high-frequency contact forces in hydraulic manipulation", \textit{Manuscript in preparation.}
...
\begin{itemize}
	\item \textbf{Excellent Paper Award} \hfill Korean Society of Mechanical Engineers, 2023 % No.2023-083, Aug 25 2023
		      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
				      \item Awarded for a first-author presentation on physics-aware modeling of contact-rich dynamics.
			      \end{itemize}}
	      \vspace*{-0.2cm}
	\item \textbf{Assistant Scholarship} \hfill Graduate School, Kyung Hee University, 2022 | 2023 % Sep. 2022 | Sep. 2023
		      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
				      \item Appointed as lead departmental assistant and received additional funding for graduate studies.
			      \end{itemize}}
	      \vspace*{-0.2cm}
	\item \textbf{Academic Superiority Scholarship} \hfill Kyung Hee University, Spring 2021 % Mar. 
		      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
				      \item Ranked 1st in class in the Department of Mechanical Engineering and received a full tuition waiver.
			      \end{itemize}}
\end{itemize}
...
--- {\footnotesize{Guiding a junior graduate student (Minjae Jung) on neural network design and sequential modeling.}} \hfill Mar. 2025 | Present\\ % Mar. 2022 | Jun. 2023
\vspace*{-0.2cm}

\noindent
\textbf{Teaching Assistant, ME380 Multibody System Dynamics} \hfill Dept. of Mechanical Eng., Kyung Hee University\\
--- {\footnotesize{Lectured on multi-body dynamics with theoretical derivation and its computational implementation.}} \hfill Mar. 2022 | Jun. 2023 % Mar. 2022 | Jun. 2023
