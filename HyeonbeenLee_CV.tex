...
\begin{etaremune}[leftmargin=.5cm, itemsep=0.05cm]
	...
	\item \textbf{H. Lee}, M. Jung, J.G. Kim et al., ``Frequency-aware probabilistic learning for sensorless force/torque forecasting on a contact-rich hydraulic manipulator", \textit{Manuscript in preparation.}

	\item B. Koo, M. Jung, \textbf{H. Lee}, T. Yeu, J.G. Kim, J.B. Han, Y. Lee, D. Park, “Buoyancy-integrated hybrid reaction force estimation method with real-time haptic feedback for underwater hydraulic manipulation”, under review at \textit{IEEE Robotics and Automation Letters (RA-L).} % {\small({$*$ Formal authorship addition is currently in process})}
...
\begin{itemize}
	\item \textbf{Excellent Paper Award} \hfill Korean Society of Mechanical Engineers, 2023 % No.2023-083, Aug 25 2023
		      {\small
			      ...
			      \end{itemize}}
	      \vspace*{-0.2cm}
	\item \textbf{Graduate Assistant Scholarship} \hfill Graduate School, Kyung Hee University, 2022 | 2023 % Sep. 2022 | Sep. 2023
		      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
