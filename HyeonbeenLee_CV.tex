...
\geometry{a4paper, margin=1.03cm} % Set paper size and margins
...
\begin{center}
	{\huge \textsc{Hyeonbeen Lee}}
\end{center}

\vspace*{-0.3cm}
\begin{center}
	\href{mailto:leehyeonbeen@vt.edu}{leehyeonbeen@vt.edu} $\bullet$ \href{https://leehyeonbeen.github.io}{Homepage} $\bullet$ \href{https://scholar.google.com/citations?user=puK1rBEAAAAJ}{Scholar} $\bullet$ \href{https://www.linkedin.com/in/leehyeonbeen/}{LinkedIn} $\bullet$ \href{https://github.com/leehyeonbeen}{GitHub}
\end{center}
...
{\footnotesize{($*$ Military leave of absence: May 2017 | Feb. 2019)}}
...
\begin{itemize}
	\item \textbf{Excellent Paper Award} \hfill Korean Society of Mechanical Engineers, 2023 % No.2023-083, Aug 25 2023
		      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
				      \item Awarded for a first-author presentation at KSME 2023 conference.
			      \end{itemize}}
	      \vspace*{-0.2cm}
	...
	\item \textbf{Graduate Assistantship} \hfill Graduate School, Kyung Hee University, 2022 | 2023 % KRW 16,046,400
		      {\small
			      ...
			      \begin{itemize}
					...
					\item Received \$11K through a graduate assistantship during M.Eng. studies.
			      \end{itemize}}
	      \vspace*{-0.2cm}
...
\noindent\textbf{Graduate School, Kyung Hee University} \hfill Research Assistant\\
Modeling \& Simulation Lab., advised by \textsl{Jin-Gyun Kim} \hfill Mar. 2024 | Apr. 2026\\
\vspace*{-0.25cm}\\
\begin{minipage}{0.78\textwidth}
	\footnotesize
	\begin{itemize}
		\item Developed a frequency-aware decomposition learning method for robotic wrench forecasting. Submitted a first-authored manuscript to the \textit{IEEE/ASME Transactions on Mechatronics (T-MECH)}.
		\item Refined the forecasting model for real-time robotic wrench estimation for \href{https://www.kriso.re.kr/eng/}{\underline{KRISO}}.
...
% \vspace*{0.12cm}
\noindent\textbf{Kim Jaechul Graduate School of AI, KAIST} \hfill Research Intern\\
Cognitive Learning for Vision \& Robotics Lab., advised by \textsl{Joseph J. Lim} \hfill Sep. 2023 | Nov. 2023\\
\vspace*{-0.25cm}\\
\begin{minipage}{0.77\textwidth}
	\footnotesize
	\begin{itemize}
		\item Conducted an in-depth review of \href{https://clvrai.github.io/spirl/}{\ul{skill-prior regularized reinforcement learning (SPiRL)}} and delivered a 90-minute presentation  to lab members and faculty.
...
\noindent\textbf{Graduate School, Kyung Hee University} \hfill Graduate Research Assistant\\
Modeling \& Simulation Lab., advised by \textsl{Jin-Gyun Kim} \hfill Mar. 2022 | Feb. 2024\\
\vspace*{-0.25cm}\\
\begin{minipage}{0.77\textwidth}
	\footnotesize
	\begin{itemize}
		\item Proposed a composite neural network architecture for learning complex dynamics from multi-order derivatives. Published a first-author article in the \textit{Journal of Computational Physics (JCOMP)}.
		\item Developed a multibody dynamics vehicle model for the \href{https://www.kaeri.re.kr/eng/}{\ul{Korea Atomic Energy Research Institute (KAERI)}}. Published a co-authored article in the \textit{Nuclear Engineering and Technology (NET)}.
		\item Designed a learning-based model to forecast the contact-rich wrench of a hydraulic manipulator for the \href{https://www.kriso.re.kr/eng/}{\ul{Korea Research Institute of Ships and Ocean Engineering (KRISO)}}.
...
\vspace*{0.1cm}
\noindent\textbf{College of Engineering, Kyung Hee University} \hfill Undergraduate Research Assistant\\
Modeling \& Simulation Lab., advised by \textsl{Jin-Gyun Kim} \hfill Jan. 2021 | Feb. 2022\\
Aerodynamic Design Exploration \& Big Data Analysis Lab, advised by \textsl{Shinkyu Jeong} \hfill Sep. 2020 | Jun. 2021\\
\vspace*{-0.25cm}\\
\begin{minipage}{0.77\textwidth}
	\footnotesize
	\begin{itemize}
		\item Investigated data-driven methods for flexible multibody dynamics and aerodynamics. 
		\item Led a thesis project on learning-based aerodynamic design optimization.
	\end{itemize}
\end{minipage}\\
\vspace*{-0.2cm}
...
\textbf{48th College of Engineering Student Council} \hfill Kyung Hee University, Feb 2019 | Jan. 2020\\
% \null\hfill \\
\textbf{ROK-U.S. Combined Marine Corps Interpreter} \hfill 1st Marine Div., ROKMC, Sep 2017 | Feb. 2019
% End document
