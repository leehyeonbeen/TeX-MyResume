...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.7\textwidth]{watermark.png}};
    \end{tikzpicture}
\vfill}}}
...
\date{\vspace{10mm}\Date{}}  %[[Alternate]]
%
...
%
\begin{letter}{\large Letter of Recommendation of \textit{\ReferrerName{}}}
    ...
    %
    \opening{Dear Ilju Foundation Committee,}
