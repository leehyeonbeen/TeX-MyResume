...
\geometry{a4paper, left=1.3cm, right=1.3cm, top=0.7cm, bottom=1.2cm} % Set paper size and margins
% \geometry{a4paper, left=0.8in, right=0.8in, top=1in, bottom=1in} % UMich
\usepackage{xhfill}
...
% Header
% \begin{center} % UMich
% 	{\footnotesize Curriculum Vitae/Resume $\bullet$ Hyeonbeen (Edward) Lee $\bullet$ Robotics Ph.D., University of Michigan}\\
% 	\vspace*{-0.2cm}
% \end{center}
\begin{center}
...
M.Eng. in Mechanical Engineering {\small(Advisor: Jin-Gyun Kim)} \hfill GPA: 4.10/4.3\\ % M.S. 3.913/4.0, 4.10/4.3, 4.33/4.5
...
B.Eng. in Mechanical Engineering {\small(Advisor: Jin-Gyun Kim, Shinkyu Jeong)}\hfill {(\ul{Upper Div.: 4.04/4.3})} GPA: 3.60/4.3\\ % B.S. Overall 3.518/4.0 ,3.599/4.3, 3.84/4.5
...
\begin{etaremune}[leftmargin=.5cm, itemsep=0.05cm]
	...
	\item \textbf{H. Lee}, S. Han, H.S. Choi, J.G. Kim (2024), “cNN-DP: Composite neural network with differential propagation for impulsive nonlinear dynamics”, \textit{Journal of Computational Physics (WoS IF Top 2.5\% in Physics, Mathematical)}, 112578. \href{https://www.sciencedirect.com/science/article/pii/S0021999123006733}{[link]} \href{https://github.com/leehyeonbeen/cNN-DP}{[code]}
