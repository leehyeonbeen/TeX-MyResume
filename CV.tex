...
\geometry{a4paper, left=1.5cm, right=1.5cm, top=0.9cm, bottom=1.2cm} % Set paper size and margins
...
M.S. in Mechanical Engineering {\small(Advisor: Jin-gyun Kim)} \hfill GPA: 4.10/4.3\\ % M.S. 3.93/4.0, 4.10/4.3, 4.33/4.5
...
\\
\textbf{Kyung Hee University} \hfill{\footnotesize(\textsl{Absence for military service in May 2017 | Feb. 2019})}\hspace*{0.25cm} Mar. 2015 | Feb. 2022\\ % University name and location
B.S. in Mechanical Engineering {\small(Advisor: Jin-gyun Kim, Shinkyu Jeong)}\hfill {(Upper Div.: 4.04/4.3)} GPA: 3.60/4.3\\ % B.S. Overall 3.52/4.0 ,3.599/4.3, 3.84/4.5
...
{\small\underline{Coursework}: Computational dynamics, Robotics, Convex optimization \& Deep learning, Numerical analysis, Finite element methods, Algorithm \& programming, Materials science, Thermodynamics, Fluid mechanics}
...
Robot learning, Sequential modeling, Sim2Real, Multimodal perception, Physics-informed learning
...
\begin{etaremune}[leftmargin=.5cm, itemsep=0.05cm]
	...
	% \item B. Koo, M. Jung, \textbf{H.lee}, T. Yeu, J.G. Kim, J.B. Han, Y. Lee, D. Park (2025), “Force estimation and haptic feedback of an underwater hydraulic manipulator using a DHP-DNN-based approach”, submitted to \textit{IEEE Robotics and Automation Letters (RA-L)}. ($\bullet$ Note: Formal authorship addition is currently in process)
	\item \textbf{H. Lee}, S. Han, H.S. Choi, J.G. Kim (2024), “cNN-DP: Composite neural network with differential propagation for impulsive nonlinear dynamics”, \textit{Journal of Computational Physics (WoS IF Top 2.5\% in Physics, Mathematical)}, 112578. \href{https://www.sciencedirect.com/science/article/pii/S0021999123006733?casa_token=ARUkhI8XI8YAAAAA:wTzCIauJvSlonWw-J-SlAFqPX6NZRQS-qBX59l4YN5O3caEppoglU0duVmMkZYf4nWYd7tm_D_E}{\color{blue}[link]} \href{https://github.com/leehyeonbeen/cNN-DP}{\color{blue}[GitHub]}
...
\begin{minipage}{0.77\textwidth}
	\small
	\begin{itemize}
		\item Developed a scalable framework for forecasting high-frequency forces of robots in contact-rich manipulation scenarios.
		\item \textbf{Ongoing:} Finalizing a manuscript for publication.
...
\begin{minipage}{0.77\textwidth}
	\small
	\begin{itemize}
		\item Conducted a two-month intensive research review on skill prior regularized reinforcement learning (SPiRL), and delivered a 90-minute technical presentation to lab members and faculty.
...
\noindent\textbf{Kyung Hee University} \hfill M.S. Student\\
Modeling \& Simulation Lab., advised by \textsl{Jin-gyun Kim} \hfill Mar. 2022 | Feb. 2024\\
\vspace*{-0.25cm}\\
\begin{minipage}{0.77\textwidth}
	\small
	\begin{itemize}
		\item Proposed a novel neural network architecture to model nonlinear dynamic systems with strong local oscillations. Resulted in a first-author publication in \textit{Journal of Computational Physics}.
		\item Accurately modeled real-world vehicle dynamics via neural metamodeling and high-fidelity simulation for a national research grant by \href{https://www.kaeri.re.kr/eng/}{KAERI}. Resulted in a co-authored publication in \textit{Nuclear Engineering and Technology}.
		\item Designed a generative model to estimate real-time, contact-rich joint forces of a marine excavation robot for a national grant by \href{https://www.kriso.re.kr/eng/}{KRISO}.
...
\begin{longtable}{LR}
	...
	\textbf{H. Lee,} S. Han, H.S. Choi, J.G. Kim. “Composite neural network framework for modeling impulsive nonlinear dynamic responses”, \textit{41th International Modal Analysis Conference (IMAC)} (Oral Presentation). \href{https://link.springer.com/chapter/10.1007/978-3-031-34946-1_21}{\color{blue}[link]}                                                                                                                                              & {Feb. 16 2023 \linebreak  Austin, TX, USA}    \\
...
\section*{SKILLS}
\begin{itemize}
	\item \textbf{Programming Languages: }Python $\cdot$ MATLAB $\cdot$ C\# $\cdot$ C++ $\cdot$ \LaTeX
...
\begin{itemize}
	\item Segment-Anybody, at \textit{Kyung Hee University Dept. of AI.} \href{https://github.com/leehyeonbeen/segment-anything-fine-tuning}{\color{blue}[GitHub]}
	...
	\item Deep seq2seq from scratch, \textit{Personal project}. \href{https://github.com/leehyeonbeen/TimeSeriesSeq2Seq}{\color{blue}[GitHub]}
	...
	\item ROS SLAM guide for Apple Silicon devices, \textit{Personal project}. \href{https://github.com/leehyeonbeen/ROS-SLAM-AppleSilicon}{\color{blue}[GitHub]}

	      {\small
		      \vspace*{-0.2cm}
		      \begin{itemize}
			      \item Addressed ROS TurtleBot3 SLAM and Gazebo compatibility issues on the latest Mac devices.
		      \end{itemize}
		      \vspace*{-0.2cm}
	      }
	...
	\item RecurDyn ProcessNet with Python, at \textit{Modeling \& Simulation Lab}. \href{https://github.com/leehyeonbeen/RecurDynPython}{\color{blue}[GitHub]}
...
--- {\small\textsl{Guiding a junior M.S. student (Minjae Jung) on time series analysis and modeling.}} \hfill Mar. 2025 | Present\\ % Mar. 2022 | Jun. 2023
\vspace*{-0.2cm}

\noindent
\textbf{Teaching Assistant, Multibody System Dynamics} \hfill Dept. of Mechanical Eng., Kyung Hee University\\
--- {\small\textsl{Lectured on computational multi-body dynamics with  theoretical derivations.}} \hfill Mar. 2022 | Jun. 2023 % Mar. 2022 | Jun. 2023
...
% \section*{REFERENCES}
% Dr. Jin-gyun Kim---\\
% Dr. Heesun Choi, Incoming professor, \\
% Dr. Seongji Han --- \\
% Dr. Joseph J. Lim\\
% Dr. Sang-hyun Kim
\end{document}