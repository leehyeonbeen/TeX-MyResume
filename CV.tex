...
Robot learning, Sequential modeling, Multimodal perception,  Physics-informed learning
...
\begin{minipage}{0.77\textwidth}
	\small
	\begin{itemize}
		\item \textbf{Ongoing:} Developed a scalable generative framework for forecasting high-frequency forces of robots in contact-rich manipulation scenarios. Finalizing a manuscript for publication.
...
\begin{minipage}{0.77\textwidth}
	\small
	\begin{itemize}
		\item Analyzed and implemented skill prior accelerated reinforcement learning (SPiRL), and delivered a technical presentation to the lab.
...
\section*{PROJECTS}
\begin{itemize}
	\item Segment-Anybody, at \textit{Kyung Hee University Dept. of AI.} (\href{https://github.com/leehyeonbeen/segment-anything-fine-tuning}{github.com/leehyeonbeen/segment-anything-fine-tuning})
	...
	\item ROS SLAM guide for Apple Silicon devices, \textit{Personal project}. (\href{https://github.com/leehyeonbeen/ROS-SLAM-AppleSilicon}{github.com/leehyeonbeen/ROS-SLAM-AppleSilicon})
	...
	\item Deep seq2seq from scratch, \textit{Personal project}. (\href{https://github.com/leehyeonbeen/TimeSeriesSeq2Seq}{github.com/leehyeonbeen/TimeSeriesSeq2Seq})
	...
	\item RecurDyn ProcessNet with Python, at \textit{Modeling \& Simulation Lab}. (\href{https://github.com/leehyeonbeen/RecurDynPython}{github.com/leehyeonbeen/RecurDynPython})

	      {\small
			      \vspace*{-0.2cm}
			      \begin{itemize}
				      \item Automated flexible multibody dynamics (FMBD) simulations of RecurDyn in parallel.
			      \end{itemize}
			      \vspace*{-0.2cm}
		      }
\end{itemize}
