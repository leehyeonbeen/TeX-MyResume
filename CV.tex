...
B.S. in Mechanical Engineering (Advisor: Jin-gyun Kim, Shinkyu Jeong)\hfill GPA: 3.52/4.0\\ % B.S. Overall 3.52/4.0 ,3.599/4.3, 3.84/4.5
% Degree and GPA
...
\begin{itemize}
	...
	\item \textbf{Software \& Frameworks: }PyTorch $\cdot$ TensorBoard $\cdot$ Git $\cdot$ Docker $\cdot$ ROS $\cdot$ RecurDyn $\cdot$ Gazebo $\cdot$ MuJoCo
	...
	\item \textbf{Natural Languages: }Korean (Native) $\cdot$ English and Japanese (Advanced proficiency)
	      %   \begin{itemize}
