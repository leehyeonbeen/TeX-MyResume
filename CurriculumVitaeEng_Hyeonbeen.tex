...
\begin{itemize}
	...
	\item \textbf{Software \& Frameworks: }PyTorch, TensorBoard, Git, Docker, ROS, RecurDyn
	\item \textbf{Machine learning: }Time series forecasting, Skill-based reinforcement learning, Image segmentation, Self-supervised learning, Physics-informed machine learning, Spectral learning, Metamodeling
	\item \textbf{Scientific computing: }Multibody dynamics, Finite element methods, Numerical analysis
