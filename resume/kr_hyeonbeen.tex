...
\begin{center}
    ...
    \begin{longtable}{LRLRLR}
        ...
        \hline
        \textbf{병역사항:} & 해병병장 만기전역 \small{(2017.05$\sim$2019.02)} & \textbf{주소:}   & 서울특별시 서초구 사임당로17길 116 & \textbf{지원분야:} & {Global Account Assistant} \\
        \hline
    \end{longtable}
\end{center}
...
\begin{itemize}
    ...
    \item \textbf{New TEPS:} 513/600 \hfill 취득번호: 0111736, 유효, 취득일: 2023.05.13
