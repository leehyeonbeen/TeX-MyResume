...
\begin{minipage}{0.1\textwidth}
    \begin{flushleft}
        \includegraphics[height=3.5cm]{pictures/photo_dlicense.jpeg}
    \end{flushleft}
\end{minipage}
\hfill
...
\begin{center}
    ...
    \begin{longtable}{LRLRLR}
        ...
        \hline
        \textbf{병역사항:} & 해병병장 만기전역 \small{(2017.05$\sim$2019.02)} & \textbf{주소:}   & 서울특별시 용산구 회나무로39길 6-3 & \textbf{지원분야:} & {매장관리 스태프} \\
        \hline
